// PVPoke Repository Explorer
// This script tests various paths to find the correct PVPoke repository structure
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { explorePVPokeRepository, testPath };
} else if (typeof window !== 'undefined') {
  window.pvpokeExplorer = { explorePVPokeRepository, testPath };
}

// Auto-run if called directly
if (typeof window !== 'undefined') {
  console.log('🚀 PVPoke Repository Explorer loaded! Run pvpokeExplorer.explorePVPokeRepository() to start.');
} 